    ...
    "must xx" in {
      ...
      val ua = Json.parse(
        """
          ...
          |               "nino":"CS121212C"
          |            },
          |            "annualAllowanceYear":"2022",
          |            "chargeDetails":{
          |               "chargeAmount":1,
          |               "dateNoticeReceived":"2022-01-01",
      ...
      val transformed = ua.transform(transformer.transformToETMPData)
...
//        userAnswersJson =>
//          println( "\n>>UA>" + userAnswersJson)
//          val tt = userAnswersJson.transform(transformer.transformToETMPData)
//
//          println( "\n>>JSRESULT>" + tt)
//                                                                                                                assert(true)
