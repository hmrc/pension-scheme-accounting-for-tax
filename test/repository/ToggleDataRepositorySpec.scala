...
class ToggleDataRepositorySpec extends AnyWordSpec with MockitoSugar with Matchers with MongoConfig with BeforeAndAfter with
  ...
  override def beforeAll(): Unit = {
    when(mockAppConfig.get[String](path = "mongodb.aft-cache.toggle-data.name")).thenReturn("toggle-data")
