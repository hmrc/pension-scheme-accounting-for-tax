...
import transformations.userAnswersToETMP.{AFTReturnTransformer, ChargeATransformer, ChargeBTransformer, ChargeFTransformer}
...
class AFTControllerSpec extends AsyncWordSpec with MustMatchers with MockitoSugar with BeforeAndAfter {
  ...
  val transformer = new AFTReturnTransformer(new ChargeATransformer, new ChargeBTransformer, new ChargeFTransformer)
