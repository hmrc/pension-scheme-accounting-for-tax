...
class AFTControllerSpec extends AsyncWordSpec with MustMatchers with MockitoSugar with BeforeAndAfter {
  ...
  val transformer = new AFTReturnTransformer(new ChargeATransformer, new ChargeBTransformer,
    new ChargeCTransformer, new ChargeDTransformer, new ChargeETransformer, new ChargeFTransformer)
